    ...
    async with _processing_semaphore:
        ...
        async with async_session() as db:
            try:
                ...
                classification = await asyncio.to_thread(classify_pdf, doc.file_path)
                ...
                rendered_pages = await asyncio.to_thread(render_pdf_pages, doc.file_path, str(page_dir))
                ...
                for page_idx, page in enumerate(pages):
                    ...
                    # If OCR produced no text, use an empty OCRResult
